    ...
    <div class="p-0  main-page">
        ...
        <div class="wallpaper" style="background-image: url({{ asset('images/wallpaper/studio.jpg')}})">
            <div class="wallpaper-card">
                ...
                <span class="wallpaper-description">
                    PRODEMY - это онлайн академия продакшена у вас дома. После регистрации вам станут доступны все обучающие курсы и статьи, общение с единомышленниками и
                    удобное обучение продакшену. Все курсы от лучших мастеров своего дела. Не имеет значения вы уже занимаетесь продакшеном или только собираетесь.
                    На портале есть материалы как с полного нуля, так и для бывалых. Все что необходимо - зарегистроваться, а затем максимально удобно обучаться любимому делу!
                </span>
